...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "wYN_WCixGn8zksDbtTr5Gafzvcu37a5s9JDn-LdN";
    private static final String SECRETKEY = "OK_UZ8kYYoZsJfTWK0yd99FOvCeTDeOJyn84mjyE";
    private static final String BUCKET = "myqqkj";
    public static final String DOMAIN= "http://qmnwpnu7v.hn-bkt.clouddn.com/";
